...
questions = [
    ...
    {
        "id": "q3",
        "text": "...vykonáte drep, prípadne sa oň aspoň pokúsite, v kolene sa Vám objaví vŕzganie a škrípanie a "
                "bolesť sa Vám zhorší.",
        "prepend_id": 3,
        "color_id": 3
    },
    {
    ...
    {
        "id": "q7",
        "text": "...si sadnete na stoličku a zatlačíte pätou bolestivej nohy o stoličku, Vaša bolesť sa v zákolení "
                "zhorší.",
        "prepend_id": 3,
        "color_id": 2
    },
